        ...
        <table class="table table-striped table-sm">
            ...
            @foreach ($categories as $categorie)
                <tr>
                  ...
                  <td><a href="/update-categorie/{{ $categorie->id }}"><button style="background-color: blue";>update</button></a></td>
                  <td><a href="/delete-categorie/{{ $categorie->id }}"><button style="background-color: red";>delete</button></a></td>
                </tr>
                @php
            $ide += 1;
        @endphp
