        ...
        <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="/categorie">
                  <svg class="bi"><use xlink:href="#file-earmark"/></svg>
  Categories
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="/produit">
                  <svg class="bi"><use xlink:href="#cart"/></svg>
                  Produits
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="/commande">
                  <svg class="bi"><use xlink:href="#people"/></svg>
                  Commandes
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="/Rendezvou">
                  <svg class="bi"><use xlink:href="#graph-up"/></svg>
                  Rendez-Vous
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="/commentaires">
