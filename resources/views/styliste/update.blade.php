...
<form method="POST" action="/update/traitement">
    ...
    <div class="form-group">
        ...
        <input type="text" value="{{$styliste->contact }}" class="form-control  {{ $errors->has('contact') ? 'is-invalid' : '' }}" id="contact" name="contact">
  ...
  <div class="form-group">
    ...
    <input type="text" value="{'$styliste->localisation}}" class="form-control  {{ $errors->has('localisation') ? 'is-invalid' : '' }}" id="localisation" name="localisation">
...
<div class="form-group">
    ...
    <input type="file" value="{{$styliste->photo}}" class="form-control  {{ $errors->has('photo') ? 'is-invalid' : '' }}" id="" name="photo">
    @if($errors->has('photo'))
